...
export const MOCK_GAMES: Game[] = [
  ...
  {
    id: '2',
    title: 'Chain Colosseum Phoenix',
    description: 'Play to Earnの要素を取り入れた、戦略性の高いターン制バトルゲーム。',
    category: 'Battle',
    chain: ChainType.OASYS_MAINNET,
    imageUrl: 'https://picsum.photos/400/300?random=2',
    tags: ['P2E', 'Battle', 'Strategy'],
    isHot: true,
  },
  {
    id: '3',
  ...
  },
  {
    id: '4',
    title: 'CryptoSpells',
    description: 'デジタルカードアセットの所有権をユーザーが持つことができる次世代カードゲーム。',
    category: 'TCG',
    chain: ChainType.TCG_VERSE,
    imageUrl: 'https://picsum.photos/400/300?random=4',
    tags: ['Card', 'Strategy', 'Esports'],
  },
  {
    id: '5',
